...
func (m *UpdateAzureImageTermsPolicyRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateAzureImageTermsPolicyRequest) validateAccepted(formats strfmt.Registry) error {
...
func (m *UpdateAzureImageTermsPolicyRequest) UnmarshalBinary(b []byte) error {
	var res UpdateAzureImageTermsPolicyRequest
