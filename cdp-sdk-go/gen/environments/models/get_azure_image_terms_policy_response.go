...
func (m *GetAzureImageTermsPolicyResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetAzureImageTermsPolicyResponse) validateAccepted(formats strfmt.Registry) error {
...
func (m *GetAzureImageTermsPolicyResponse) UnmarshalBinary(b []byte) error {
	var res GetAzureImageTermsPolicyResponse
