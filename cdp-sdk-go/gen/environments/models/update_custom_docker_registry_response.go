...
func (m *UpdateCustomDockerRegistryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateCustomDockerRegistryResponse) validateEnvironment(formats strfmt.Registry) error {
...
func (m *UpdateCustomDockerRegistryResponse) contextValidateEnvironment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateCustomDockerRegistryResponse) UnmarshalBinary(b []byte) error {
	var res UpdateCustomDockerRegistryResponse
