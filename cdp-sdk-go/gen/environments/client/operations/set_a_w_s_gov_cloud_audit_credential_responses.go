...
func (o *SetAWSGovCloudAuditCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewSetAWSGovCloudAuditCredentialDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewSetAWSGovCloudAuditCredentialOK() *SetAWSGovCloudAuditCredentialOK {
	return &SetAWSGovCloudAuditCredentialOK{}
}
...
func (o *SetAWSGovCloudAuditCredentialOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewSetAWSGovCloudAuditCredentialDefault(code int) *SetAWSGovCloudAuditCredentialDefault {
	return &SetAWSGovCloudAuditCredentialDefault{
		_statusCode: code,
	}
}
...
*/
type SetAWSGovCloudAuditCredentialDefault struct {
	_statusCode int
...
func (o *SetAWSGovCloudAuditCredentialDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
