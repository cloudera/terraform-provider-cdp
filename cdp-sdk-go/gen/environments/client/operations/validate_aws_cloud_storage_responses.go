...
func (o *ValidateAwsCloudStorageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ValidateAwsCloudStorageOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/environments2/validateAwsCloudStorage][%d] validateAwsCloudStorageOK %s", 200, payload)
}
...
func (o *ValidateAwsCloudStorageDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/environments2/validateAwsCloudStorage][%d] validateAwsCloudStorage default %s", o._statusCode, payload)
}
