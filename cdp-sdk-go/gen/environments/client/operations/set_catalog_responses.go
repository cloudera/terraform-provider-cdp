...
func (o *SetCatalogOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/environments2/setCatalog][%d] setCatalogOK  %+v", 200, o.Payload)
}
...
func (o *SetCatalogDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/environments2/setCatalog][%d] setCatalog default  %+v", o._statusCode, o.Payload)
}
