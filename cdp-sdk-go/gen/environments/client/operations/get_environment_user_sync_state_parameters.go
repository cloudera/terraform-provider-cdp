...
func NewGetEnvironmentUserSyncStateParams() *GetEnvironmentUserSyncStateParams {
	return NewGetEnvironmentUserSyncStateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetEnvironmentUserSyncStateParams].
