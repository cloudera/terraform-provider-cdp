...
func NewTestAccountTelemetryRulesParams() *TestAccountTelemetryRulesParams {
	return NewTestAccountTelemetryRulesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [TestAccountTelemetryRulesParams].
