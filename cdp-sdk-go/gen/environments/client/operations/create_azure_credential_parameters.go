...
func NewCreateAzureCredentialParams() *CreateAzureCredentialParams {
	return NewCreateAzureCredentialParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateAzureCredentialParams].
