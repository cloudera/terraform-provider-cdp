...
func NewCreateProxyConfigParams() *CreateProxyConfigParams {
	return NewCreateProxyConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateProxyConfigParams].
