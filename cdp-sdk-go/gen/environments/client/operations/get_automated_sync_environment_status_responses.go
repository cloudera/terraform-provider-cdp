...
func (o *GetAutomatedSyncEnvironmentStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetAutomatedSyncEnvironmentStatusOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/environments2/getAutomatedSyncEnvironmentStatus][%d] getAutomatedSyncEnvironmentStatusOK %s", 200, payload)
}
...
func (o *GetAutomatedSyncEnvironmentStatusDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/environments2/getAutomatedSyncEnvironmentStatus][%d] getAutomatedSyncEnvironmentStatus default %s", o._statusCode, payload)
}
