...
func NewStartEnvironmentParams() *StartEnvironmentParams {
	return NewStartEnvironmentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [StartEnvironmentParams].
