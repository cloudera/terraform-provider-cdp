...
func (o *CreateAWSGovCloudCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateAWSGovCloudCredentialOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/environments2/createAWSGovCloudCredential][%d] createAWSGovCloudCredentialOK %s", 200, payload)
}
...
func (o *CreateAWSGovCloudCredentialDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/environments2/createAWSGovCloudCredential][%d] createAWSGovCloudCredential default %s", o._statusCode, payload)
}
