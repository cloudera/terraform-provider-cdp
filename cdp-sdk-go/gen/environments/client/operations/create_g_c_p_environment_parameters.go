...
func NewCreateGCPEnvironmentParams() *CreateGCPEnvironmentParams {
	return NewCreateGCPEnvironmentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateGCPEnvironmentParams].
