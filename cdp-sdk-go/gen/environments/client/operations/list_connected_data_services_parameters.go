...
// NewListConnectedDataServicesParams creates a new ListConnectedDataServicesParams object,
...
func NewListConnectedDataServicesParams() *ListConnectedDataServicesParams {
	return NewListConnectedDataServicesParamsWithTimeout(cr.DefaultTimeout)
}

// NewListConnectedDataServicesParamsWithTimeout creates a new ListConnectedDataServicesParams object
// with the ability to set a timeout on a request.
func NewListConnectedDataServicesParamsWithTimeout(timeout time.Duration) *ListConnectedDataServicesParams {
	return &ListConnectedDataServicesParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewListConnectedDataServicesParamsWithContext creates a new ListConnectedDataServicesParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [ListConnectedDataServicesParams].
...
// NewListConnectedDataServicesParamsWithHTTPClient creates a new ListConnectedDataServicesParams object
...
*/
type ListConnectedDataServicesParams struct {

	// Input.
	Input *models.ListConnectedDataServicesRequest
