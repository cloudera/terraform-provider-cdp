...
func (o *SetEndpointAccessGatewayReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewSetEndpointAccessGatewayDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewSetEndpointAccessGatewayOK() *SetEndpointAccessGatewayOK {
	return &SetEndpointAccessGatewayOK{}
}
...
func NewSetEndpointAccessGatewayDefault(code int) *SetEndpointAccessGatewayDefault {
	return &SetEndpointAccessGatewayDefault{
		_statusCode: code,
	}
}
...
func (o *SetEndpointAccessGatewayDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
