...
func (o *UpdateAzureDatabaseResourcesOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/environments2/updateAzureDatabaseResources][%d] updateAzureDatabaseResourcesOK  %+v", 200, o.Payload)
}
...
func (o *UpdateAzureDatabaseResourcesDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/environments2/updateAzureDatabaseResources][%d] updateAzureDatabaseResources default  %+v", o._statusCode, o.Payload)
}
