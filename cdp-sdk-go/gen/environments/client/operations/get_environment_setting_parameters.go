...
func NewGetEnvironmentSettingParams() *GetEnvironmentSettingParams {
	return NewGetEnvironmentSettingParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetEnvironmentSettingParams].
