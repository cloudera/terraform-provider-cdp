...
func (o *UpdateProxyConfigOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/environments2/updateProxyConfig][%d] updateProxyConfigOK  %+v", 200, o.Payload)
}
...
func (o *UpdateProxyConfigDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/environments2/updateProxyConfig][%d] updateProxyConfig default  %+v", o._statusCode, o.Payload)
}
