...
func (o *SyncAllUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SyncAllUsersOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/environments2/syncAllUsers][%d] syncAllUsersOK %s", 200, payload)
}
...
func (o *SyncAllUsersDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/environments2/syncAllUsers][%d] syncAllUsers default %s", o._statusCode, payload)
}
