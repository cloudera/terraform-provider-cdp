...
func NewInitializeAWSComputeClusterParams() *InitializeAWSComputeClusterParams {
	return NewInitializeAWSComputeClusterParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [InitializeAWSComputeClusterParams].
