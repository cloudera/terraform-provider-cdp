...
func NewCollectFreeipaDiagnosticsParams() *CollectFreeipaDiagnosticsParams {
	return NewCollectFreeipaDiagnosticsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CollectFreeipaDiagnosticsParams].
