...
// NewUpdateAwsCredentialParamsWithHTTPClient creates a new UpdateAwsCredentialParams object
...
func (o *UpdateAwsCredentialParams) WithDefaults() *UpdateAwsCredentialParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update aws credential params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateAwsCredentialParams) SetDefaults() {
