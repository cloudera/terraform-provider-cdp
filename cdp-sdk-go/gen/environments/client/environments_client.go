...
// Default environments HTTP client.
...
// NewHTTPClient creates a new environments HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Environments {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new environments HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Environments {
...
// New creates a new environments client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Environments {
	// ensure nullable parameters have default
	if formats == nil {
		formats = strfmt.Default
	}

	cli := new(Environments)
...
// Environments is a client for environments.
...
func (c *Environments) SetTransport(transport runtime.ContextualTransport) {
