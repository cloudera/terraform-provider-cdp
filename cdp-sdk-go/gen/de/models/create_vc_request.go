...
type CreateVcRequest struct {
	...
	// Enum: ["SPARK2","SPARK2_4","SPARK3","SPARK3_0","SPARK3_1","SPARK3_2","SPARK3_3","SPARK3_5","SPARK3_5_4"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["SPARK2","SPARK2_4","SPARK3","SPARK3_0","SPARK3_1","SPARK3_2","SPARK3_3","SPARK3_5","SPARK3_5_4"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// CreateVcRequestSparkVersionSPARK354 captures enum value "SPARK3_5_4"
	CreateVcRequestSparkVersionSPARK354 string = "SPARK3_5_4"
)
