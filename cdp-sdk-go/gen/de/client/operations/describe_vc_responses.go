...
func (o *DescribeVcReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewDescribeVcOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDescribeVcDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *DescribeVcOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/de/describeVc][%d] describeVcOK %s", 200, payload)
}
...
func (o *DescribeVcOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DescribeVcResponse)
...
func (o *DescribeVcDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/de/describeVc][%d] describeVc default %s", o._statusCode, payload)
}
...
func (o *DescribeVcDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
