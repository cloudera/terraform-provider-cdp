...
func (o *ListBackupsOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/de/listBackups][%d] listBackupsOK %s", 200, payload)
}
...
func (o *ListBackupsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/de/listBackups][%d] listBackups default %s", o._statusCode, payload)
}
