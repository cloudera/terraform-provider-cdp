...
func NewDescribeServiceParams() *DescribeServiceParams {
	return NewDescribeServiceParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DescribeServiceParams].
