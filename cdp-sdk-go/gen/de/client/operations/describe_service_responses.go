...
func (o *DescribeServiceOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/de/describeService][%d] describeServiceOK %s", 200, payload)
}
...
func (o *DescribeServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/de/describeService][%d] describeService default %s", o._statusCode, payload)
}
