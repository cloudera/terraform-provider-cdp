...
func NewGetUpgradeStatusParams() *GetUpgradeStatusParams {
	return NewGetUpgradeStatusParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetUpgradeStatusParams].
