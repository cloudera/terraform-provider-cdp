...
func NewDisableServiceParams() *DisableServiceParams {
	return NewDisableServiceParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DisableServiceParams].
