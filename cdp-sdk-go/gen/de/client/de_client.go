...
// NewHTTPClient creates a new de HTTP client.
func NewHTTPClient(formats strfmt.Registry) *De {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new de HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *De {
...
// New creates a new de client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *De {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *De) SetTransport(transport runtime.ContextualTransport) {
