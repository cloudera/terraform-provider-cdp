...
func (o *UpgradeServiceOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/upgradeService][%d] upgradeServiceOK %s", 200, payload)
}
...
func (o *UpgradeServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/upgradeService][%d] upgradeService default %s", o._statusCode, payload)
}
