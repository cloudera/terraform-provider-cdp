...
type UpdateProjectParams struct {
	...
	// Input.
	Input *models.UpdateProjectRequest
...
// WithInput adds the input to the update project params
func (o *UpdateProjectParams) WithInput(input *models.UpdateProjectRequest) *UpdateProjectParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the update project params
func (o *UpdateProjectParams) SetInput(input *models.UpdateProjectRequest) {
	o.Input = input
}
