...
func (o *DisableServiceOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/disableService][%d] disableServiceOK %s", 200, payload)
}
...
func (o *DisableServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/disableService][%d] disableService default %s", o._statusCode, payload)
}
