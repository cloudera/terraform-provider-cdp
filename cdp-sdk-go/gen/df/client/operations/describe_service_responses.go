...
func (o *DescribeServiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DescribeServiceOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/describeService][%d] describeServiceOK %s", 200, payload)
}
...
func (o *DescribeServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DescribeServiceResponse)
...
func (o *DescribeServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/describeService][%d] describeService default %s", o._statusCode, payload)
}
