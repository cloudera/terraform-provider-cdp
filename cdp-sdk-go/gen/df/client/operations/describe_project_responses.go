...
func (o *DescribeProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewDescribeProjectOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDescribeProjectDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
type DescribeProjectOK struct {
	Payload *models.DescribeProjectResponse
}
...
func (o *DescribeProjectOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/describeProject][%d] describeProjectOK %s", 200, payload)
}
...
func (o *DescribeProjectOK) GetPayload() *models.DescribeProjectResponse {
	return o.Payload
}

func (o *DescribeProjectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DescribeProjectResponse)
...
func (o *DescribeProjectDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/describeProject][%d] describeProject default %s", o._statusCode, payload)
}
...
func (o *DescribeProjectDefault) GetPayload() *models.Error {
	return o.Payload
}

func (o *DescribeProjectDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
