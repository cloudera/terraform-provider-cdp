...
func (o *ListDiagnosticsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListDiagnosticsOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/listDiagnostics][%d] listDiagnosticsOK %s", 200, payload)
}
...
func (o *ListDiagnosticsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/listDiagnostics][%d] listDiagnostics default %s", o._statusCode, payload)
}
