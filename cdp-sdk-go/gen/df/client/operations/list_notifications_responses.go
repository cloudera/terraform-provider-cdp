...
func (o *ListNotificationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type ListNotificationsOK struct {
	Payload *models.ListNotificationsResponse
}
...
func (o *ListNotificationsOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/listNotifications][%d] listNotificationsOK %s", 200, payload)
}
...
func (o *ListNotificationsOK) GetPayload() *models.ListNotificationsResponse {
	return o.Payload
}
...
func (o *ListNotificationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListNotificationsResponse)
...
func (o *ListNotificationsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/listNotifications][%d] listNotifications default %s", o._statusCode, payload)
}
...
func (o *ListNotificationsDefault) GetPayload() *models.Error {
	return o.Payload
}
