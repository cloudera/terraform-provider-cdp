...
func (o *UpdateServiceOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/updateService][%d] updateServiceOK %s", 200, payload)
}
...
func (o *UpdateServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/updateService][%d] updateService default %s", o._statusCode, payload)
}
