...
func (o *RenewCertificatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RenewCertificatesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/renewCertificates][%d] renewCertificatesOK %s", 200, payload)
}
...
func (o *RenewCertificatesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/renewCertificates][%d] renewCertificates default %s", o._statusCode, payload)
}
