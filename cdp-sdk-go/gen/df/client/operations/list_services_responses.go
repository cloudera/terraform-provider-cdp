...
func (o *ListServicesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/listServices][%d] listServicesOK %s", 200, payload)
}
...
func (o *ListServicesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/listServices][%d] listServices default %s", o._statusCode, payload)
}
