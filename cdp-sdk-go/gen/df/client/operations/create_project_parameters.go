...
type CreateProjectParams struct {
	...
	// Input.
	Input *models.CreateProjectRequest
...
// WithInput adds the input to the create project params
func (o *CreateProjectParams) WithInput(input *models.CreateProjectRequest) *CreateProjectParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the create project params
func (o *CreateProjectParams) SetInput(input *models.CreateProjectRequest) {
	o.Input = input
}
