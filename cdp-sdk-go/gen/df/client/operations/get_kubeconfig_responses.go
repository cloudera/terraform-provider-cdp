...
func (o *GetKubeconfigOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/getKubeconfig][%d] getKubeconfigOK %s", 200, payload)
}
...
func (o *GetKubeconfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/getKubeconfig][%d] getKubeconfig default %s", o._statusCode, payload)
}
