...
type DeleteProjectParams struct {
	...
	// Input.
	Input *models.DeleteProjectRequest
...
// WithInput adds the input to the delete project params
func (o *DeleteProjectParams) WithInput(input *models.DeleteProjectRequest) *DeleteProjectParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the delete project params
func (o *DeleteProjectParams) SetInput(input *models.DeleteProjectRequest) {
	o.Input = input
}
