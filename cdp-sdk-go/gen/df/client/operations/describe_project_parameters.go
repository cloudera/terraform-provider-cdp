...
// NewDescribeProjectParams creates a new DescribeProjectParams object,
...
func NewDescribeProjectParams() *DescribeProjectParams {
	return &DescribeProjectParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDescribeProjectParamsWithTimeout creates a new DescribeProjectParams object
...
// NewDescribeProjectParamsWithContext creates a new DescribeProjectParams object
...
// NewDescribeProjectParamsWithHTTPClient creates a new DescribeProjectParams object
...
type DescribeProjectParams struct {
	...
	// Input.
	Input *models.DescribeProjectRequest
...
// WithInput adds the input to the describe project params
func (o *DescribeProjectParams) WithInput(input *models.DescribeProjectRequest) *DescribeProjectParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the describe project params
func (o *DescribeProjectParams) SetInput(input *models.DescribeProjectRequest) {
	o.Input = input
}
