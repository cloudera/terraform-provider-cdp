...
type ListProjectsParams struct {
	...
	// Input.
	Input *models.ListProjectsRequest
...
// WithInput adds the input to the list projects params
func (o *ListProjectsParams) WithInput(input *models.ListProjectsRequest) *ListProjectsParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the list projects params
func (o *ListProjectsParams) SetInput(input *models.ListProjectsRequest) {
	o.Input = input
}
