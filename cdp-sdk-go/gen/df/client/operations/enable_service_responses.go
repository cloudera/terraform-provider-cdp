...
func (o *EnableServiceOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/df/enableService][%d] enableServiceOK %s", 200, payload)
}
...
func (o *EnableServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/df/enableService][%d] enableService default %s", o._statusCode, payload)
}
