...
// NewHTTPClient creates a new datahub HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Datahub {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new datahub HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Datahub {
...
// New creates a new datahub client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Datahub {
	// ensure nullable parameters have default
	if formats == nil {
...
// Datahub is a client for datahub.
type Datahub struct {
...
func (c *Datahub) SetTransport(transport runtime.ContextualTransport) {
