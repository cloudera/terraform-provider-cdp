...
func (o *DescribeClusterOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/describeCluster][%d] describeClusterOK %s", 200, payload)
}
...
func (o *DescribeClusterDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/describeCluster][%d] describeCluster default %s", o._statusCode, payload)
}
