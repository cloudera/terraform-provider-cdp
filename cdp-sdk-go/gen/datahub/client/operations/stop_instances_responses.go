...
func (o *StopInstancesOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/stopInstances][%d] stopInstancesOK  %+v", 200, o.Payload)
}
...
func (o *StopInstancesDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/stopInstances][%d] stopInstances default  %+v", o._statusCode, o.Payload)
}
