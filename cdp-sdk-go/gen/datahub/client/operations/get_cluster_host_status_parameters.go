...
func NewGetClusterHostStatusParams() *GetClusterHostStatusParams {
	return NewGetClusterHostStatusParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetClusterHostStatusParams].
