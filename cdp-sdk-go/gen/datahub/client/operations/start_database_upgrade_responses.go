...
func (o *StartDatabaseUpgradeOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/startDatabaseUpgrade][%d] startDatabaseUpgradeOK  %+v", 200, o.Payload)
}
...
func (o *StartDatabaseUpgradeDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/startDatabaseUpgrade][%d] startDatabaseUpgrade default  %+v", o._statusCode, o.Payload)
}
