...
func (o *RenewCertificateOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/renewCertificate][%d] renewCertificateOK  %+v", 200, o.Payload)
}
...
func (o *RenewCertificateDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/renewCertificate][%d] renewCertificate default  %+v", o._statusCode, o.Payload)
}
