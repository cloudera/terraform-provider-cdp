...
func (o *RenewCertificateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RenewCertificateOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/renewCertificate][%d] renewCertificateOK %s", 200, payload)
}
...
func (o *RenewCertificateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.RenewCertificateResponse)
...
func (o *RenewCertificateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/renewCertificate][%d] renewCertificate default %s", o._statusCode, payload)
}
