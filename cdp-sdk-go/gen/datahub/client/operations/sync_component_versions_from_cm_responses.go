...
func (o *SyncComponentVersionsFromCmReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewSyncComponentVersionsFromCmOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewSyncComponentVersionsFromCmDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *SyncComponentVersionsFromCmOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/syncComponentVersionsFromCm][%d] syncComponentVersionsFromCmOK %s", 200, payload)
}
...
func NewSyncComponentVersionsFromCmDefault(code int) *SyncComponentVersionsFromCmDefault {
	return &SyncComponentVersionsFromCmDefault{
		_statusCode: code,
	}
}
...
func (o *SyncComponentVersionsFromCmDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/syncComponentVersionsFromCm][%d] syncComponentVersionsFromCm default %s", o._statusCode, payload)
}
...
func (o *SyncComponentVersionsFromCmDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
