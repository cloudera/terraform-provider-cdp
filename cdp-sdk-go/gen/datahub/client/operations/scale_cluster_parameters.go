...
func NewScaleClusterParams() *ScaleClusterParams {
	return NewScaleClusterParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ScaleClusterParams].
