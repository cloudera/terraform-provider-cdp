...
func NewDescribeClusterTemplateParams() *DescribeClusterTemplateParams {
	return NewDescribeClusterTemplateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DescribeClusterTemplateParams].
