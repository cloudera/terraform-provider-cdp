...
func (o *RotateDbCertificateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
...
func (o *RotateDbCertificateOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/rotateDbCertificate][%d] rotateDbCertificateOK %s", 200, payload)
}
...
func (o *RotateDbCertificateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/rotateDbCertificate][%d] rotateDbCertificate default %s", o._statusCode, payload)
}
