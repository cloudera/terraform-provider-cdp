...
func NewStartClusterVerticalScalingParams() *StartClusterVerticalScalingParams {
	return NewStartClusterVerticalScalingParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [StartClusterVerticalScalingParams].
