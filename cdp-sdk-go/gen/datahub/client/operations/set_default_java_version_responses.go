...
func (o *SetDefaultJavaVersionOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/setDefaultJavaVersion][%d] setDefaultJavaVersionOK %s", 200, payload)
}
...
func (o *SetDefaultJavaVersionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/setDefaultJavaVersion][%d] setDefaultJavaVersion default %s", o._statusCode, payload)
}
