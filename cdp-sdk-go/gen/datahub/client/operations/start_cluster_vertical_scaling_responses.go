...
func (o *StartClusterVerticalScalingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StartClusterVerticalScalingOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/startClusterVerticalScaling][%d] startClusterVerticalScalingOK %s", 200, payload)
}
...
func (o *StartClusterVerticalScalingDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/startClusterVerticalScaling][%d] startClusterVerticalScaling default %s", o._statusCode, payload)
}
