...
func (o *RotatePrivateCertificatesOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/rotatePrivateCertificates][%d] rotatePrivateCertificatesOK  %+v", 200, o.Payload)
}
...
func (o *RotatePrivateCertificatesDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/rotatePrivateCertificates][%d] rotatePrivateCertificates default  %+v", o._statusCode, o.Payload)
}
