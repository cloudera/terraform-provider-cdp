...
func (o *GetOperationOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/getOperation][%d] getOperationOK %s", 200, payload)
}
...
func (o *GetOperationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/getOperation][%d] getOperation default %s", o._statusCode, payload)
}
