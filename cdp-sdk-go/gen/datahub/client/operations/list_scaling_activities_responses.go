...
func (o *ListScalingActivitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewListScalingActivitiesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewListScalingActivitiesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ListScalingActivitiesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/listScalingActivities][%d] listScalingActivitiesOK %s", 200, payload)
}
...
func (o *ListScalingActivitiesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListScalingActivitiesResponse)
...
func NewListScalingActivitiesDefault(code int) *ListScalingActivitiesDefault {
	return &ListScalingActivitiesDefault{
		_statusCode: code,
	}
}
...
func (o *ListScalingActivitiesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/listScalingActivities][%d] listScalingActivities default %s", o._statusCode, payload)
}
...
func (o *ListScalingActivitiesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
