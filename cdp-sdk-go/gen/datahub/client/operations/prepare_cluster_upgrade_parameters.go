...
func NewPrepareClusterUpgradeParams() *PrepareClusterUpgradeParams {
	return NewPrepareClusterUpgradeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PrepareClusterUpgradeParams].
