...
func (o *RotateAutoTLSCertificatesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datahub/rotateAutoTlsCertificates][%d] rotateAutoTlsCertificatesOK %s", 200, payload)
}
...
func (o *RotateAutoTLSCertificatesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datahub/rotateAutoTlsCertificates][%d] rotateAutoTlsCertificates default %s", o._statusCode, payload)
}
