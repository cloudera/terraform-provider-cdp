...
func (o *RotateAutoTLSCertificatesOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/rotateAutoTlsCertificates][%d] rotateAutoTlsCertificatesOK  %+v", 200, o.Payload)
}
...
func (o *RotateAutoTLSCertificatesDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/rotateAutoTlsCertificates][%d] rotateAutoTlsCertificates default  %+v", o._statusCode, o.Payload)
}
