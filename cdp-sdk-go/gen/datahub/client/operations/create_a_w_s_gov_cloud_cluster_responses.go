...
func (o *CreateAWSGovCloudClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewCreateAWSGovCloudClusterOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCreateAWSGovCloudClusterDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCreateAWSGovCloudClusterOK() *CreateAWSGovCloudClusterOK {
	return &CreateAWSGovCloudClusterOK{}
}
...
func (o *CreateAWSGovCloudClusterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CreateAWSGovCloudClusterResponse)
...
func NewCreateAWSGovCloudClusterDefault(code int) *CreateAWSGovCloudClusterDefault {
	return &CreateAWSGovCloudClusterDefault{
		_statusCode: code,
	}
}
...
func (o *CreateAWSGovCloudClusterDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
