...
func NewCreateRecipeParams() *CreateRecipeParams {
	return NewCreateRecipeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateRecipeParams].
