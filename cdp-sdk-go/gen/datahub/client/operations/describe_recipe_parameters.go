...
func NewDescribeRecipeParams() *DescribeRecipeParams {
	return NewDescribeRecipeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DescribeRecipeParams].
