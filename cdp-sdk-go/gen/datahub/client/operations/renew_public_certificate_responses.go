...
func (o *RenewPublicCertificateOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/renewPublicCertificate][%d] renewPublicCertificateOK  %+v", 200, o.Payload)
}
...
func (o *RenewPublicCertificateDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datahub/renewPublicCertificate][%d] renewPublicCertificate default  %+v", o._statusCode, o.Payload)
}
