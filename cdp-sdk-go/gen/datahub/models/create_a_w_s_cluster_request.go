...
type CreateAWSClusterRequest struct {
	...
	// Max hourly price of spot instances in all the instance groups. (This may override the already set spotMaxPrice values under the instanceGroup(s))
	// Maximum: 255
	// Minimum: 0.001
...
func (m *CreateAWSClusterRequest) validateOverallSpotMaxPrice(formats strfmt.Registry) error {
