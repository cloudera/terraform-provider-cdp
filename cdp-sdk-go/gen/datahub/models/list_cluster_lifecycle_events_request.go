...
func (m *ListClusterLifecycleEventsRequest) validateCluster(formats strfmt.Registry) error {
...
func (m *ListClusterLifecycleEventsRequest) validatePageSize(formats strfmt.Registry) error {
...
func (m *ListClusterLifecycleEventsRequest) UnmarshalBinary(b []byte) error {
	var res ListClusterLifecycleEventsRequest
