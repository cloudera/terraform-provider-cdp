...
const (
	...
	// DatahubDatabaseTypeONROOTVOLUME captures enum value "ON_ROOT_VOLUME"
	DatahubDatabaseTypeONROOTVOLUME DatahubDatabaseType = "ON_ROOT_VOLUME"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["HA","NON_HA","NONE","ON_ROOT_VOLUME"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
