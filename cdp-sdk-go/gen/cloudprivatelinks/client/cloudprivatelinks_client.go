...
// Default cloudprivatelinks HTTP client.
...
// NewHTTPClient creates a new cloudprivatelinks HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Cloudprivatelinks {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new cloudprivatelinks HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Cloudprivatelinks {
...
// New creates a new cloudprivatelinks client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Cloudprivatelinks {
	// ensure nullable parameters have default
	if formats == nil {
		formats = strfmt.Default
	}

	cli := new(Cloudprivatelinks)
...
// Cloudprivatelinks is a client for cloudprivatelinks.
type Cloudprivatelinks struct {
...
func (c *Cloudprivatelinks) SetTransport(transport runtime.ContextualTransport) {
