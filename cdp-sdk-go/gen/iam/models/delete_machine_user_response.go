...
func (m *DeleteMachineUserResponse) validateAccessKeysDeleted(formats strfmt.Registry) error {
...
func (m *DeleteMachineUserResponse) validateGroupsModified(formats strfmt.Registry) error {
...
func (m *DeleteMachineUserResponse) validateResourcesUnassigned(formats strfmt.Registry) error {
...
func (m *DeleteMachineUserResponse) validateRolesUnassigned(formats strfmt.Registry) error {
...
func (m *DeleteMachineUserResponse) UnmarshalBinary(b []byte) error {
	var res DeleteMachineUserResponse
