...
func (m *ListGroupAssignedRolesRequest) validateGroupName(formats strfmt.Registry) error {
...
func (m *ListGroupAssignedRolesRequest) validatePageSize(formats strfmt.Registry) error {
...
func (m *ListGroupAssignedRolesRequest) UnmarshalBinary(b []byte) error {
	var res ListGroupAssignedRolesRequest
