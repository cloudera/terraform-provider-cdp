...
func (m *ListMachineUserAssignedResourceRolesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListMachineUserAssignedResourceRolesResponse) validateResourceAssignments(formats strfmt.Registry) error {
...
func (m *ListMachineUserAssignedResourceRolesResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ListMachineUserAssignedResourceRolesResponse) contextValidateResourceAssignments(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListMachineUserAssignedResourceRolesResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
