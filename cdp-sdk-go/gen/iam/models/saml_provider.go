...
type SamlProvider struct {
	...
	// Format: date-time
	AuthnRequestConfigurationLastUpdated strfmt.DateTime `json:"authnRequestConfigurationLastUpdated,omitempty"`

	// Whether the AuthnRequest signing key is set or cleared.
	AuthnRequestSigningKeyDefined bool `json:"authnRequestSigningKeyDefined,omitempty"`
	...
	CurrentAuthnRequestVerificationCertificateDefined bool `json:"currentAuthnRequestVerificationCertificateDefined,omitempty"`

	// Whether the current decryption key for SAML response is set or cleared.
	CurrentSamlResponseDecryptionKeyDefined bool `json:"currentSamlResponseDecryptionKeyDefined,omitempty"`
	...
	NextAuthnRequestVerificationCertificateDefined bool `json:"nextAuthnRequestVerificationCertificateDefined,omitempty"`

	// Whether the next decryption key for SAML response is set or cleared.
	NextSamlResponseDecryptionKeyDefined bool `json:"nextSamlResponseDecryptionKeyDefined,omitempty"`
	...
	SamlResponseEncryptionCertificateDefined bool `json:"samlResponseEncryptionCertificateDefined,omitempty"`

	// The date when SAML response encryption certificate and decryption keys were set or cleared.
	// Format: date-time
	SamlResponseEncryptionDecryptionConfigurationLastUpdated strfmt.DateTime `json:"samlResponseEncryptionDecryptionConfigurationLastUpdated,omitempty"`
