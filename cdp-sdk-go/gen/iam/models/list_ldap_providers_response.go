...
// ContextValidate validate this list ldap providers response based on the context it is used
func (m *ListLdapProvidersResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ListLdapProvidersResponse) contextValidateLdapProviders(ctx context.Context, formats strfmt.Registry) error {
