...
// ListTermsRequest Request object for a list terms request.
//
// swagger:model ListTermsRequest
...
// Validate validates this list terms request
func (m *ListTermsRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListTermsRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListTermsRequest) UnmarshalBinary(b []byte) error {
	var res ListTermsRequest
