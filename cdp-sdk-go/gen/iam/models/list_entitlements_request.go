...
// ContextValidate validates this list entitlements request based on context it is used
func (m *ListEntitlementsRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
