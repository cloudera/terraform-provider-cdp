...
// ContextValidate validate this list entitlements response based on the context it is used
func (m *ListEntitlementsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ListEntitlementsResponse) contextValidateEntitlements(ctx context.Context, formats strfmt.Registry) error {
