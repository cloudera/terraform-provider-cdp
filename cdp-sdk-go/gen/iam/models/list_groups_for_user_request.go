...
func (m *ListGroupsForUserRequest) validatePageSize(formats strfmt.Registry) error {
...
func (m *ListGroupsForUserRequest) validateUserID(formats strfmt.Registry) error {
...
func (m *ListGroupsForUserRequest) UnmarshalBinary(b []byte) error {
	var res ListGroupsForUserRequest
