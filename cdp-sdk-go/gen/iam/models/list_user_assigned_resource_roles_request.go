...
func (m *ListUserAssignedResourceRolesRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListUserAssignedResourceRolesRequest) validatePageSize(formats strfmt.Registry) error {
...
func (m *ListUserAssignedResourceRolesRequest) UnmarshalBinary(b []byte) error {
	var res ListUserAssignedResourceRolesRequest
