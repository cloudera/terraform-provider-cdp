...
func (o *SetAuthenticationPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewSetAuthenticationPolicyOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewSetAuthenticationPolicyDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewSetAuthenticationPolicyOK() *SetAuthenticationPolicyOK {
	return &SetAuthenticationPolicyOK{}
}
...
func (o *SetAuthenticationPolicyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewSetAuthenticationPolicyDefault(code int) *SetAuthenticationPolicyDefault {
	return &SetAuthenticationPolicyDefault{
		_statusCode: code,
	}
}
...
func (o *SetAuthenticationPolicyDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
