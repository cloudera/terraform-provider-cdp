...
// NewDescribeSamlProviderParams creates a new DescribeSamlProviderParams object,
...
func NewDescribeSamlProviderParams() *DescribeSamlProviderParams {
	return NewDescribeSamlProviderParamsWithTimeout(cr.DefaultTimeout)
}

// NewDescribeSamlProviderParamsWithTimeout creates a new DescribeSamlProviderParams object
// with the ability to set a timeout on a request.
func NewDescribeSamlProviderParamsWithTimeout(timeout time.Duration) *DescribeSamlProviderParams {
	return &DescribeSamlProviderParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewDescribeSamlProviderParamsWithContext creates a new DescribeSamlProviderParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [DescribeSamlProviderParams].
...
// NewDescribeSamlProviderParamsWithHTTPClient creates a new DescribeSamlProviderParams object
