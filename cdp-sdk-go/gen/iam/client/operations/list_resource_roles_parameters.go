...
func NewListResourceRolesParams() *ListResourceRolesParams {
	return NewListResourceRolesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListResourceRolesParams].
