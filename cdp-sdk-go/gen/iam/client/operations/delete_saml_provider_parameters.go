...
func NewDeleteSamlProviderParams() *DeleteSamlProviderParams {
	return NewDeleteSamlProviderParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteSamlProviderParams].
