...
func NewListGroupsForMachineUserParams() *ListGroupsForMachineUserParams {
	return NewListGroupsForMachineUserParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListGroupsForMachineUserParams].
