...
func (o *UpdateUserOK) Error() string {
	return fmt.Sprintf("[POST /iam/updateUser][%d] updateUserOK  %+v", 200, o.Payload)
}
...
func (o *UpdateUserDefault) Error() string {
	return fmt.Sprintf("[POST /iam/updateUser][%d] updateUser default  %+v", o._statusCode, o.Payload)
}
