...
func NewSetDefaultIdentityProviderParams() *SetDefaultIdentityProviderParams {
	return NewSetDefaultIdentityProviderParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SetDefaultIdentityProviderParams].
