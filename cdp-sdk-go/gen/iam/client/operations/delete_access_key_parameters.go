...
func NewDeleteAccessKeyParams() *DeleteAccessKeyParams {
	return NewDeleteAccessKeyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteAccessKeyParams].
