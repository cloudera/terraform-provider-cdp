...
func NewListMachineUserAssignedResourceRolesParams() *ListMachineUserAssignedResourceRolesParams {
	return NewListMachineUserAssignedResourceRolesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListMachineUserAssignedResourceRolesParams].
