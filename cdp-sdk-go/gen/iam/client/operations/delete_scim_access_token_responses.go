...
func (o *DeleteScimAccessTokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewDeleteScimAccessTokenOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDeleteScimAccessTokenDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteScimAccessTokenOK() *DeleteScimAccessTokenOK {
	return &DeleteScimAccessTokenOK{}
}
...
func (o *DeleteScimAccessTokenOK) Error() string {
	...
	return fmt.Sprintf("[POST /iam/deleteScimAccessToken][%d] deleteScimAccessTokenOK %s", 200, payload)
}
...
func (o *DeleteScimAccessTokenOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteScimAccessTokenDefault(code int) *DeleteScimAccessTokenDefault {
	return &DeleteScimAccessTokenDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteScimAccessTokenDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iam/deleteScimAccessToken][%d] deleteScimAccessToken default %s", o._statusCode, payload)
}
...
func (o *DeleteScimAccessTokenDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
