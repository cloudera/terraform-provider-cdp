...
func (o *GetDefaultIdentityProviderReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewGetDefaultIdentityProviderOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewGetDefaultIdentityProviderDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetDefaultIdentityProviderOK() *GetDefaultIdentityProviderOK {
	return &GetDefaultIdentityProviderOK{}
}
...
func (o *GetDefaultIdentityProviderOK) Code() int {
	return 200
}

func (o *GetDefaultIdentityProviderOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iam/getDefaultIdentityProvider][%d] getDefaultIdentityProviderOK %s", 200, payload)
}

func (o *GetDefaultIdentityProviderOK) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iam/getDefaultIdentityProvider][%d] getDefaultIdentityProviderOK %s", 200, payload)
}

func (o *GetDefaultIdentityProviderOK) GetPayload() *models.GetDefaultIdentityProviderResponse {
	return o.Payload
}

func (o *GetDefaultIdentityProviderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetDefaultIdentityProviderResponse)
...
func NewGetDefaultIdentityProviderDefault(code int) *GetDefaultIdentityProviderDefault {
	return &GetDefaultIdentityProviderDefault{
		_statusCode: code,
	}
}
...
func (o *GetDefaultIdentityProviderDefault) Code() int {
	return o._statusCode
}

func (o *GetDefaultIdentityProviderDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iam/getDefaultIdentityProvider][%d] getDefaultIdentityProvider default %s", o._statusCode, payload)
}

func (o *GetDefaultIdentityProviderDefault) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /iam/getDefaultIdentityProvider][%d] getDefaultIdentityProvider default %s", o._statusCode, payload)
}

func (o *GetDefaultIdentityProviderDefault) GetPayload() *models.Error {
	return o.Payload
}

func (o *GetDefaultIdentityProviderDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
