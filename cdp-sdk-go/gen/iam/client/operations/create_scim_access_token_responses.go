...
func (o *CreateScimAccessTokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewCreateScimAccessTokenOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCreateScimAccessTokenDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCreateScimAccessTokenOK() *CreateScimAccessTokenOK {
	return &CreateScimAccessTokenOK{}
}
...
func (o *CreateScimAccessTokenOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CreateScimAccessTokenResponse)
...
func NewCreateScimAccessTokenDefault(code int) *CreateScimAccessTokenDefault {
	return &CreateScimAccessTokenDefault{
		_statusCode: code,
	}
}
...
func (o *CreateScimAccessTokenDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
