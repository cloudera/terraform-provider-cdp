...
// NewHTTPClient creates a new iam HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Iam {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new iam HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Iam {
...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Iam {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *Iam) SetTransport(transport runtime.ContextualTransport) {
