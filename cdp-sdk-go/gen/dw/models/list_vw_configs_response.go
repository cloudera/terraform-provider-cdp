...
func (m *ListVwConfigsResponse) validateConfigHistory(formats strfmt.Registry) error {
...
func (m *ListVwConfigsResponse) contextValidateConfigHistory(ctx context.Context, formats strfmt.Registry) error {
