...
func (m *DescribeServerSettingItem) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRequiresUpdate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DescribeServerSettingItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRequiresUpdate(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *DescribeServerSettingItem) contextValidateRequiresUpdate(ctx context.Context, formats strfmt.Registry) error {
