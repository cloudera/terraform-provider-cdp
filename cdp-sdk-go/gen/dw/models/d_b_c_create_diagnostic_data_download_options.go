...
func (m *DBCCreateDiagnosticDataDownloadOptions) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this d b c create diagnostic data download options based on context it is used
func (m *DBCCreateDiagnosticDataDownloadOptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *DBCCreateDiagnosticDataDownloadOptions) UnmarshalBinary(b []byte) error {
	var res DBCCreateDiagnosticDataDownloadOptions
