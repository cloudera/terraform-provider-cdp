...
func (m *DescribeVwDiagnosticDataJobResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DescribeVwDiagnosticDataJobResponse) validateJob(formats strfmt.Registry) error {
...
func (m *DescribeVwDiagnosticDataJobResponse) contextValidateJob(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DescribeVwDiagnosticDataJobResponse) UnmarshalBinary(b []byte) error {
	var res DescribeVwDiagnosticDataJobResponse
