...
func (m *DescribeDbcConfigRequest) validateClusterID(formats strfmt.Registry) error {
...
func (m *DescribeDbcConfigRequest) validateDbcID(formats strfmt.Registry) error {
...
func (m *DescribeDbcConfigRequest) UnmarshalBinary(b []byte) error {
	var res DescribeDbcConfigRequest
