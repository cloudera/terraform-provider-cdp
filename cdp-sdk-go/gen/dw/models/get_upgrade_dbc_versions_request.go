...
func (m *GetUpgradeDbcVersionsRequest) validateClusterID(formats strfmt.Registry) error {
...
func (m *GetUpgradeDbcVersionsRequest) validateDbcID(formats strfmt.Registry) error {
...
func (m *GetUpgradeDbcVersionsRequest) UnmarshalBinary(b []byte) error {
	var res GetUpgradeDbcVersionsRequest
