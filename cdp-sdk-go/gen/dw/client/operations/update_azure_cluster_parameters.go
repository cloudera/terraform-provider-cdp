...
func NewUpdateAzureClusterParams() *UpdateAzureClusterParams {
	return NewUpdateAzureClusterParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateAzureClusterParams].
