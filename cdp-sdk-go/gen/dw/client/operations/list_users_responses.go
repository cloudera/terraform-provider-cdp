...
func (o *ListUsersOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/listUsers][%d] listUsersOK %s", 200, payload)
}
...
func (o *ListUsersDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/listUsers][%d] listUsers default %s", o._statusCode, payload)
}
