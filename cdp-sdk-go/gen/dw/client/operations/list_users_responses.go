...
func (o *ListUsersOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/listUsers][%d] listUsersOK  %+v", 200, o.Payload)
}
...
func (o *ListUsersDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/listUsers][%d] listUsers default  %+v", o._statusCode, o.Payload)
}
