...
// NewCreatePrivateClusterParams creates a new CreatePrivateClusterParams object,
...
func NewCreatePrivateClusterParams() *CreatePrivateClusterParams {
	return NewCreatePrivateClusterParamsWithTimeout(cr.DefaultTimeout)
}

// NewCreatePrivateClusterParamsWithTimeout creates a new CreatePrivateClusterParams object
// with the ability to set a timeout on a request.
func NewCreatePrivateClusterParamsWithTimeout(timeout time.Duration) *CreatePrivateClusterParams {
	return &CreatePrivateClusterParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewCreatePrivateClusterParamsWithContext creates a new CreatePrivateClusterParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [CreatePrivateClusterParams].
...
// NewCreatePrivateClusterParamsWithHTTPClient creates a new CreatePrivateClusterParams object
