...
func (o *UpgradeClusterOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/upgradeCluster][%d] upgradeClusterOK %s", 200, payload)
}
...
func (o *UpgradeClusterDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/upgradeCluster][%d] upgradeCluster default %s", o._statusCode, payload)
}
