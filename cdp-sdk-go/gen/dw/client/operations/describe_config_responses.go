...
func (o *DescribeConfigOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/describeConfig][%d] describeConfigOK  %+v", 200, o.Payload)
}
...
func (o *DescribeConfigDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/describeConfig][%d] describeConfig default  %+v", o._statusCode, o.Payload)
}
