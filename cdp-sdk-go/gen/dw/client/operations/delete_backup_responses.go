...
func (o *DeleteBackupOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteBackup][%d] deleteBackupOK  %+v", 200, o.Payload)
}
...
func (o *DeleteBackupDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteBackup][%d] deleteBackup default  %+v", o._statusCode, o.Payload)
}
