...
func (o *DeleteUserOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/deleteUser][%d] deleteUserOK %s", 200, payload)
}
...
func (o *DeleteUserDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/deleteUser][%d] deleteUser default %s", o._statusCode, payload)
}
