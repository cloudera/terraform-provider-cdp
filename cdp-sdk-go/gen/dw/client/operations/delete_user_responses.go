...
func (o *DeleteUserOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteUser][%d] deleteUserOK  %+v", 200, o.Payload)
}
...
func (o *DeleteUserDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteUser][%d] deleteUser default  %+v", o._statusCode, o.Payload)
}
