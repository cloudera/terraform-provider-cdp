...
func NewCreateResourceTemplateParams() *CreateResourceTemplateParams {
	return NewCreateResourceTemplateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateResourceTemplateParams].
