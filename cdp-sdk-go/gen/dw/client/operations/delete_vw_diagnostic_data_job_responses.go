...
func (o *DeleteVwDiagnosticDataJobReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewDeleteVwDiagnosticDataJobOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDeleteVwDiagnosticDataJobDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDeleteVwDiagnosticDataJobOK() *DeleteVwDiagnosticDataJobOK {
	return &DeleteVwDiagnosticDataJobOK{}
}
...
func (o *DeleteVwDiagnosticDataJobOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/deleteVwDiagnosticDataJob][%d] deleteVwDiagnosticDataJobOK %s", 200, payload)
}
...
func (o *DeleteVwDiagnosticDataJobOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewDeleteVwDiagnosticDataJobDefault(code int) *DeleteVwDiagnosticDataJobDefault {
	return &DeleteVwDiagnosticDataJobDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteVwDiagnosticDataJobDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/deleteVwDiagnosticDataJob][%d] deleteVwDiagnosticDataJob default %s", o._statusCode, payload)
}
...
func (o *DeleteVwDiagnosticDataJobDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
