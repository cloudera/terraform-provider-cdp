...
func (o *DeleteVwDiagnosticDataJobOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteVwDiagnosticDataJob][%d] deleteVwDiagnosticDataJobOK  %+v", 200, o.Payload)
}
...
func (o *DeleteVwDiagnosticDataJobDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteVwDiagnosticDataJob][%d] deleteVwDiagnosticDataJob default  %+v", o._statusCode, o.Payload)
}
