...
func (o *CreateBackupOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/createBackup][%d] createBackupOK %s", 200, payload)
}
...
func (o *CreateBackupDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/createBackup][%d] createBackup default %s", o._statusCode, payload)
}
