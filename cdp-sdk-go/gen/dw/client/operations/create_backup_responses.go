...
func (o *CreateBackupOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/createBackup][%d] createBackupOK  %+v", 200, o.Payload)
}
...
func (o *CreateBackupDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/createBackup][%d] createBackup default  %+v", o._statusCode, o.Payload)
}
