...
func NewDeleteDbcDiagnosticDataJobParams() *DeleteDbcDiagnosticDataJobParams {
	return NewDeleteDbcDiagnosticDataJobParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteDbcDiagnosticDataJobParams].
