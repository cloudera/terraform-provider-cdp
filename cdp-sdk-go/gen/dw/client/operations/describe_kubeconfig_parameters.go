...
func NewDescribeKubeconfigParams() *DescribeKubeconfigParams {
	return NewDescribeKubeconfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DescribeKubeconfigParams].
