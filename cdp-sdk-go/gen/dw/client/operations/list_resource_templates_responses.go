...
func (o *ListResourceTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewListResourceTemplatesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewListResourceTemplatesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ListResourceTemplatesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/listResourceTemplates][%d] listResourceTemplatesOK %s", 200, payload)
}
...
func (o *ListResourceTemplatesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListResourceTemplatesResponse)
...
func NewListResourceTemplatesDefault(code int) *ListResourceTemplatesDefault {
	return &ListResourceTemplatesDefault{
		_statusCode: code,
	}
}
...
func (o *ListResourceTemplatesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/listResourceTemplates][%d] listResourceTemplates default %s", o._statusCode, payload)
}
...
func (o *ListResourceTemplatesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
