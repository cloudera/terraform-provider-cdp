...
func (o *UpdateSSHKeyOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/updateSshKey][%d] updateSshKeyOK  %+v", 200, o.Payload)
}
...
func (o *UpdateSSHKeyDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/updateSshKey][%d] updateSshKey default  %+v", o._statusCode, o.Payload)
}
