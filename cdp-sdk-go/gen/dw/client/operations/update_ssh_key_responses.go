...
func (o *UpdateSSHKeyOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/updateSshKey][%d] updateSshKeyOK %s", 200, payload)
}
...
func (o *UpdateSSHKeyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/updateSshKey][%d] updateSshKey default %s", o._statusCode, payload)
}
