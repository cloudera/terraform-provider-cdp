...
func NewResumeClusterParams() *ResumeClusterParams {
	return NewResumeClusterParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ResumeClusterParams].
