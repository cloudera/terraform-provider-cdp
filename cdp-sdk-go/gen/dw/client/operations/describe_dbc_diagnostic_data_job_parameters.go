...
func NewDescribeDbcDiagnosticDataJobParams() *DescribeDbcDiagnosticDataJobParams {
	return NewDescribeDbcDiagnosticDataJobParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DescribeDbcDiagnosticDataJobParams].
