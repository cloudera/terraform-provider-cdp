...
func (o *UpgradeDataVisualizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewUpgradeDataVisualizationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewUpgradeDataVisualizationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewUpgradeDataVisualizationOK() *UpgradeDataVisualizationOK {
	return &UpgradeDataVisualizationOK{}
}
...
func (o *UpgradeDataVisualizationOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/upgradeDataVisualization][%d] upgradeDataVisualizationOK %s", 200, payload)
}
...
func (o *UpgradeDataVisualizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.UpgradeDataVisualizationResponse)
...
func NewUpgradeDataVisualizationDefault(code int) *UpgradeDataVisualizationDefault {
	return &UpgradeDataVisualizationDefault{
		_statusCode: code,
	}
}
...
func (o *UpgradeDataVisualizationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/upgradeDataVisualization][%d] upgradeDataVisualization default %s", o._statusCode, payload)
}
...
func (o *UpgradeDataVisualizationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
