...
func NewListVwEventsParams() *ListVwEventsParams {
	return NewListVwEventsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListVwEventsParams].
