...
func (o *CreateAzureClusterOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/createAzureCluster][%d] createAzureClusterOK  %+v", 200, o.Payload)
}
...
func (o *CreateAzureClusterDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/createAzureCluster][%d] createAzureCluster default  %+v", o._statusCode, o.Payload)
}
