...
func NewCreateBackupParams() *CreateBackupParams {
	return NewCreateBackupParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateBackupParams].
