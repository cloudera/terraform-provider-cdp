...
func (o *DeleteDbcDiagnosticDataJobOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteDbcDiagnosticDataJob][%d] deleteDbcDiagnosticDataJobOK  %+v", 200, o.Payload)
}
...
func (o *DeleteDbcDiagnosticDataJobDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteDbcDiagnosticDataJob][%d] deleteDbcDiagnosticDataJob default  %+v", o._statusCode, o.Payload)
}
