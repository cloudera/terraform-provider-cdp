...
func (o *CreateClusterDiagnosticDataJobReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewCreateClusterDiagnosticDataJobOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCreateClusterDiagnosticDataJobDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCreateClusterDiagnosticDataJobOK() *CreateClusterDiagnosticDataJobOK {
	return &CreateClusterDiagnosticDataJobOK{}
}
...
func (o *CreateClusterDiagnosticDataJobOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CreateClusterDiagnosticDataJobResponse)
...
func NewCreateClusterDiagnosticDataJobDefault(code int) *CreateClusterDiagnosticDataJobDefault {
	return &CreateClusterDiagnosticDataJobDefault{
		_statusCode: code,
	}
}
...
func (o *CreateClusterDiagnosticDataJobDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
