...
func (o *DeleteClusterOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteCluster][%d] deleteClusterOK  %+v", 200, o.Payload)
}
...
func (o *DeleteClusterDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteCluster][%d] deleteCluster default  %+v", o._statusCode, o.Payload)
}
