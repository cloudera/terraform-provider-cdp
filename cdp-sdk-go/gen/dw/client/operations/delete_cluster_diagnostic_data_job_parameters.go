...
func NewDeleteClusterDiagnosticDataJobParams() *DeleteClusterDiagnosticDataJobParams {
	return NewDeleteClusterDiagnosticDataJobParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteClusterDiagnosticDataJobParams].
