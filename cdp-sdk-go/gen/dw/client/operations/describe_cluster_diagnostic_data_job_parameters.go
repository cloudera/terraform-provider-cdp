...
func NewDescribeClusterDiagnosticDataJobParams() *DescribeClusterDiagnosticDataJobParams {
	return NewDescribeClusterDiagnosticDataJobParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DescribeClusterDiagnosticDataJobParams].
