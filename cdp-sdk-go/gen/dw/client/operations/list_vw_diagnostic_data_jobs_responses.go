...
func (o *ListVwDiagnosticDataJobsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/listVwDiagnosticDataJobs][%d] listVwDiagnosticDataJobsOK  %+v", 200, o.Payload)
}
...
func (o *ListVwDiagnosticDataJobsDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/listVwDiagnosticDataJobs][%d] listVwDiagnosticDataJobs default  %+v", o._statusCode, o.Payload)
}
