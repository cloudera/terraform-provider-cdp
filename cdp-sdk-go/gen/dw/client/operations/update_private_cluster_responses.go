...
func (o *UpdatePrivateClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewUpdatePrivateClusterOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewUpdatePrivateClusterDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *UpdatePrivateClusterOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/updatePrivateCluster][%d] updatePrivateClusterOK %s", 200, payload)
}
...
func (o *UpdatePrivateClusterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdatePrivateClusterDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/updatePrivateCluster][%d] updatePrivateCluster default %s", o._statusCode, payload)
}
...
func (o *UpdatePrivateClusterDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
