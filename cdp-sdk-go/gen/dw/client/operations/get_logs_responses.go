...
func (o *GetLogsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/getLogs][%d] getLogsOK  %+v", 200, o.Payload)
}
...
func (o *GetLogsDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/getLogs][%d] getLogs default  %+v", o._statusCode, o.Payload)
}
