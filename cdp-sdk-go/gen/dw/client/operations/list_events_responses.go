...
func (o *ListEventsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/listEvents][%d] listEventsOK  %+v", 200, o.Payload)
}
...
func (o *ListEventsDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/listEvents][%d] listEvents default  %+v", o._statusCode, o.Payload)
}
