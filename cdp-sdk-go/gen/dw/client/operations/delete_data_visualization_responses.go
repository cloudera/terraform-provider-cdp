...
func (o *DeleteDataVisualizationOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteDataVisualization][%d] deleteDataVisualizationOK  %+v", 200, o.Payload)
}
...
func (o *DeleteDataVisualizationDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/dw/deleteDataVisualization][%d] deleteDataVisualization default  %+v", o._statusCode, o.Payload)
}
