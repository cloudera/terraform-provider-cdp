...
func (o *UpgradeDbcReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewUpgradeDbcOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewUpgradeDbcDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *UpgradeDbcOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/upgradeDbc][%d] upgradeDbcOK %s", 200, payload)
}
...
func (o *UpgradeDbcOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.UpgradeDbcResponse)
...
func (o *UpgradeDbcDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/upgradeDbc][%d] upgradeDbc default %s", o._statusCode, payload)
}
...
func (o *UpgradeDbcDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
