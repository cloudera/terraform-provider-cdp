...
func (o *DescribeDataVisualizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewDescribeDataVisualizationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDescribeDataVisualizationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDescribeDataVisualizationOK() *DescribeDataVisualizationOK {
	return &DescribeDataVisualizationOK{}
}
...
func (o *DescribeDataVisualizationOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/dw/describeDataVisualization][%d] describeDataVisualizationOK %s", 200, payload)
}
...
func (o *DescribeDataVisualizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DescribeDataVisualizationResponse)
...
func NewDescribeDataVisualizationDefault(code int) *DescribeDataVisualizationDefault {
	return &DescribeDataVisualizationDefault{
		_statusCode: code,
	}
}
...
func (o *DescribeDataVisualizationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/dw/describeDataVisualization][%d] describeDataVisualization default %s", o._statusCode, payload)
}
...
func (o *DescribeDataVisualizationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
