...
// NewHTTPClient creates a new dw HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Dw {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new dw HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Dw {
...
// New creates a new dw client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Dw {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *Dw) SetTransport(transport runtime.ContextualTransport) {
