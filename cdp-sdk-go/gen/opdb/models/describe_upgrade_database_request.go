...
func (m *DescribeUpgradeDatabaseRequest) validateDatabase(formats strfmt.Registry) error {
...
func (m *DescribeUpgradeDatabaseRequest) validateEnvironment(formats strfmt.Registry) error {
...
func (m *DescribeUpgradeDatabaseRequest) UnmarshalBinary(b []byte) error {
	var res DescribeUpgradeDatabaseRequest
