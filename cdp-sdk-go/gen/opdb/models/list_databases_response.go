...
func (m *ListDatabasesResponse) validateDatabases(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.Databases); i++ {
		if typeutils.IsZero(m.Databases[i]) { // not required
			continue
		}
...
func (m *ListDatabasesResponse) contextValidateDatabases(ctx context.Context, formats strfmt.Registry) error {
