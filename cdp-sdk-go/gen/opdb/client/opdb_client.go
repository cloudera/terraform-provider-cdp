...
// NewHTTPClient creates a new opdb HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Opdb {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new opdb HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Opdb {
...
// New creates a new opdb client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Opdb {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *Opdb) SetTransport(transport runtime.ContextualTransport) {
