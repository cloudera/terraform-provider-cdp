...
func NewListSnapshotsParams() *ListSnapshotsParams {
	return NewListSnapshotsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListSnapshotsParams].
