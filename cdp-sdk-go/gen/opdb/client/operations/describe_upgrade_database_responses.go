...
func (o *DescribeUpgradeDatabaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewDescribeUpgradeDatabaseOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDescribeUpgradeDatabaseDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDescribeUpgradeDatabaseOK() *DescribeUpgradeDatabaseOK {
	return &DescribeUpgradeDatabaseOK{}
}
...
func (o *DescribeUpgradeDatabaseOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/opdb/describeUpgradeDatabase][%d] describeUpgradeDatabaseOK %s", 200, payload)
}
...
func (o *DescribeUpgradeDatabaseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DescribeUpgradeDatabaseResponse)
...
func NewDescribeUpgradeDatabaseDefault(code int) *DescribeUpgradeDatabaseDefault {
	return &DescribeUpgradeDatabaseDefault{
		_statusCode: code,
	}
}
...
*/
type DescribeUpgradeDatabaseDefault struct {
	_statusCode int
...
func (o *DescribeUpgradeDatabaseDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/opdb/describeUpgradeDatabase][%d] describeUpgradeDatabase default %s", o._statusCode, payload)
}
...
func (o *DescribeUpgradeDatabaseDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
