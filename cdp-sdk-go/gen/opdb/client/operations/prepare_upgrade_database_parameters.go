...
// NewPrepareUpgradeDatabaseParams creates a new PrepareUpgradeDatabaseParams object,
...
func NewPrepareUpgradeDatabaseParams() *PrepareUpgradeDatabaseParams {
	return NewPrepareUpgradeDatabaseParamsWithTimeout(cr.DefaultTimeout)
}

// NewPrepareUpgradeDatabaseParamsWithTimeout creates a new PrepareUpgradeDatabaseParams object
// with the ability to set a timeout on a request.
func NewPrepareUpgradeDatabaseParamsWithTimeout(timeout time.Duration) *PrepareUpgradeDatabaseParams {
	return &PrepareUpgradeDatabaseParams{
		inner: innerParams{
			timeout: timeout,
		},
	}
...
// NewPrepareUpgradeDatabaseParamsWithContext creates a new PrepareUpgradeDatabaseParams object
// with the ability to set a context for a request.
//
// Deprecated: use the operation call with context to pass the context instead of [PrepareUpgradeDatabaseParams].
...
// NewPrepareUpgradeDatabaseParamsWithHTTPClient creates a new PrepareUpgradeDatabaseParams object
...
PrepareUpgradeDatabaseParams contains all the parameters to send to the API endpoint
	...
	for the prepare upgrade database operation.

	Typically these are written to a http.Request.
*/
type PrepareUpgradeDatabaseParams struct {

	// Input.
	Input *models.PrepareUpgradeDatabaseRequest
