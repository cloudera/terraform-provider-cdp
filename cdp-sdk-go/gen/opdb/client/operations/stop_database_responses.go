...
func (o *StopDatabaseOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/opdb/stopDatabase][%d] stopDatabaseOK  %+v", 200, o.Payload)
}
...
func (o *StopDatabaseDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/opdb/stopDatabase][%d] stopDatabase default  %+v", o._statusCode, o.Payload)
}
