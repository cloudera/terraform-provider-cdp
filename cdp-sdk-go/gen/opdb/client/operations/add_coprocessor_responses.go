...
func (o *AddCoprocessorOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/opdb/addCoprocessor][%d] addCoprocessorOK  %+v", 200, o.Payload)
}
...
func (o *AddCoprocessorDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/opdb/addCoprocessor][%d] addCoprocessor default  %+v", o._statusCode, o.Payload)
}
