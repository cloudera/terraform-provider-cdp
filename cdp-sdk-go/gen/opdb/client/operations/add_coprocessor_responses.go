...
func (o *AddCoprocessorReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewAddCoprocessorOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewAddCoprocessorDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *AddCoprocessorOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/opdb/addCoprocessor][%d] addCoprocessorOK %s", 200, payload)
}
...
func (o *AddCoprocessorOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.AddCoprocessorResponse)
...
*/
type AddCoprocessorDefault struct {
	_statusCode int
...
func (o *AddCoprocessorDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/opdb/addCoprocessor][%d] addCoprocessor default %s", o._statusCode, payload)
}
...
func (o *AddCoprocessorDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
