...
func NewGrantWorkspaceAccessParams() *GrantWorkspaceAccessParams {
	return NewGrantWorkspaceAccessParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GrantWorkspaceAccessParams].
