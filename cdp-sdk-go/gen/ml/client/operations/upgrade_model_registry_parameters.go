...
func NewUpgradeModelRegistryParams() *UpgradeModelRegistryParams {
	return NewUpgradeModelRegistryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpgradeModelRegistryParams].
