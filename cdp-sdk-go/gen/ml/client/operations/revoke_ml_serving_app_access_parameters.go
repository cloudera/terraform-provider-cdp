...
func NewRevokeMlServingAppAccessParams() *RevokeMlServingAppAccessParams {
	return NewRevokeMlServingAppAccessParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [RevokeMlServingAppAccessParams].
