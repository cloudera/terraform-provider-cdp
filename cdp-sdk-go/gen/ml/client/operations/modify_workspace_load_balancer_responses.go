...
func (o *ModifyWorkspaceLoadBalancerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewModifyWorkspaceLoadBalancerOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewModifyWorkspaceLoadBalancerDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewModifyWorkspaceLoadBalancerOK() *ModifyWorkspaceLoadBalancerOK {
	return &ModifyWorkspaceLoadBalancerOK{}
}
...
func (o *ModifyWorkspaceLoadBalancerOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/ml/modifyWorkspaceLoadBalancer][%d] modifyWorkspaceLoadBalancerOK %s", 200, payload)
}
...
func (o *ModifyWorkspaceLoadBalancerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewModifyWorkspaceLoadBalancerDefault(code int) *ModifyWorkspaceLoadBalancerDefault {
	return &ModifyWorkspaceLoadBalancerDefault{
		_statusCode: code,
	}
}
...
func (o *ModifyWorkspaceLoadBalancerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/ml/modifyWorkspaceLoadBalancer][%d] modifyWorkspaceLoadBalancer default %s", o._statusCode, payload)
}
...
func (o *ModifyWorkspaceLoadBalancerDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
