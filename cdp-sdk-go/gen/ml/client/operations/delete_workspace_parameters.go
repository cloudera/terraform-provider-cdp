...
func NewDeleteWorkspaceParams() *DeleteWorkspaceParams {
	return NewDeleteWorkspaceParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteWorkspaceParams].
