...
func (o *ModifyMlServingAppReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewModifyMlServingAppOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewModifyMlServingAppDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ModifyMlServingAppOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/ml/modifyMlServingApp][%d] modifyMlServingAppOK %s", 200, payload)
}
...
func (o *ModifyMlServingAppOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewModifyMlServingAppDefault(code int) *ModifyMlServingAppDefault {
	return &ModifyMlServingAppDefault{
		_statusCode: code,
	}
}
...
func (o *ModifyMlServingAppDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/ml/modifyMlServingApp][%d] modifyMlServingApp default %s", o._statusCode, payload)
}
...
func (o *ModifyMlServingAppDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
