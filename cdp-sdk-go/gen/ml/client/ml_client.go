...
// NewHTTPClient creates a new ml HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Ml {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new ml HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Ml {
...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Ml {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *Ml) SetTransport(transport runtime.ContextualTransport) {
