...
type CreateWorkspaceRequest struct {
	...
	// Legacy CDSW to private cloud migration timeout (in minutes).
	...
	// The version of Kuberenetes to provision.
...
func (m *CreateWorkspaceRequest) validateImageCatalog(formats strfmt.Registry) error {
...
func (m *CreateWorkspaceRequest) contextValidateImageCatalog(ctx context.Context, formats strfmt.Registry) error {
