...
type GrantMlServingAppAccessResponse struct {
...
// Validate validates this grant ml serving app access response
...
func (m *GrantMlServingAppAccessResponse) validateKubeconfig(formats strfmt.Registry) error {
...
func (m *GrantMlServingAppAccessResponse) UnmarshalBinary(b []byte) error {
	var res GrantMlServingAppAccessResponse
