...
func (o *CollectCmDiagnosticsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/collectCmDiagnostics][%d] collectCmDiagnosticsOK  %+v", 200, o.Payload)
}
...
func (o *CollectCmDiagnosticsDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/collectCmDiagnostics][%d] collectCmDiagnostics default  %+v", o._statusCode, o.Payload)
}
