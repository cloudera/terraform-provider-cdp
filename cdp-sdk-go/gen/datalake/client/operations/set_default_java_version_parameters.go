...
func NewSetDefaultJavaVersionParams() *SetDefaultJavaVersionParams {
	return NewSetDefaultJavaVersionParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SetDefaultJavaVersionParams].
