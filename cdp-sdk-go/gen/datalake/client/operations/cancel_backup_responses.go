...
func (o *CancelBackupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CancelBackupOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/cancelBackup][%d] cancelBackupOK %s", 200, payload)
}
...
func (o *CancelBackupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CancelBackupResponse)
...
func (o *CancelBackupDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/cancelBackup][%d] cancelBackup default %s", o._statusCode, payload)
}
