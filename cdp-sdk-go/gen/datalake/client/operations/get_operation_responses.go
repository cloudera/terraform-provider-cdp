...
func (o *GetOperationOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/getOperation][%d] getOperationOK  %+v", 200, o.Payload)
}
...
func (o *GetOperationDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/getOperation][%d] getOperation default  %+v", o._statusCode, o.Payload)
}
