...
func (o *ValidateAzureCloudStorageOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/validateAzureCloudStorage][%d] validateAzureCloudStorageOK  %+v", 200, o.Payload)
}
...
func (o *ValidateAzureCloudStorageDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/validateAzureCloudStorage][%d] validateAzureCloudStorage default  %+v", o._statusCode, o.Payload)
}
