...
func (o *GetClusterServiceStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetClusterServiceStatusOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/getClusterServiceStatus][%d] getClusterServiceStatusOK %s", 200, payload)
}
...
func (o *GetClusterServiceStatusDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/getClusterServiceStatus][%d] getClusterServiceStatus default %s", o._statusCode, payload)
}
