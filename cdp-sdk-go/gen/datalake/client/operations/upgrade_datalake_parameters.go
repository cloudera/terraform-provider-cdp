...
func NewUpgradeDatalakeParams() *UpgradeDatalakeParams {
	return NewUpgradeDatalakeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpgradeDatalakeParams].
