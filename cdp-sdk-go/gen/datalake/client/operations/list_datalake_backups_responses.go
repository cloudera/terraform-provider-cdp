...
func (o *ListDatalakeBackupsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListDatalakeBackupsOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/listDatalakeBackups][%d] listDatalakeBackupsOK %s", 200, payload)
}
...
func (o *ListDatalakeBackupsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/listDatalakeBackups][%d] listDatalakeBackups default %s", o._statusCode, payload)
}
