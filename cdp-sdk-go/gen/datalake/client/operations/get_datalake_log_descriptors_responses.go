...
func (o *GetDatalakeLogDescriptorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	switch response.Code() {
	case 200:
		result := NewGetDatalakeLogDescriptorsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewGetDatalakeLogDescriptorsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *GetDatalakeLogDescriptorsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetDatalakeLogDescriptorsResponse)
...
func NewGetDatalakeLogDescriptorsDefault(code int) *GetDatalakeLogDescriptorsDefault {
	return &GetDatalakeLogDescriptorsDefault{
		_statusCode: code,
	}
}
...
func (o *GetDatalakeLogDescriptorsDefault) Code() int {
...
func (o *GetDatalakeLogDescriptorsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
