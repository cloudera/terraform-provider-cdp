...
func (o *UpdateOrchestratorStateOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/updateOrchestratorState][%d] updateOrchestratorStateOK %s", 200, payload)
}
...
func (o *UpdateOrchestratorStateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/updateOrchestratorState][%d] updateOrchestratorState default %s", o._statusCode, payload)
}
