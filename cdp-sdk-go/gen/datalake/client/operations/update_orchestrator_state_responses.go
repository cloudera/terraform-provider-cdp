...
func (o *UpdateOrchestratorStateOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/updateOrchestratorState][%d] updateOrchestratorStateOK  %+v", 200, o.Payload)
}
...
func (o *UpdateOrchestratorStateDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/updateOrchestratorState][%d] updateOrchestratorState default  %+v", o._statusCode, o.Payload)
}
