...
func (o *GetCmRolesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCmRolesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/getCmRoles][%d] getCmRolesOK %s", 200, payload)
}
...
func (o *GetCmRolesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/getCmRoles][%d] getCmRoles default %s", o._statusCode, payload)
}
