...
func NewScaleHorizontallyParams() *ScaleHorizontallyParams {
	return NewScaleHorizontallyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ScaleHorizontallyParams].
