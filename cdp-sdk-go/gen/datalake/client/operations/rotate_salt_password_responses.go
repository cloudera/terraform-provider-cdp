...
func (o *RotateSaltPasswordOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/rotateSaltPassword][%d] rotateSaltPasswordOK  %+v", 200, o.Payload)
}
...
func (o *RotateSaltPasswordDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/rotateSaltPassword][%d] rotateSaltPassword default  %+v", o._statusCode, o.Payload)
}
