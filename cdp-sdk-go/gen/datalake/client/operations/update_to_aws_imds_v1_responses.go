...
func (o *UpdateToAwsImdsV1OK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/updateToAwsImdsV1][%d] updateToAwsImdsV1OK  %+v", 200, o.Payload)
}
...
func (o *UpdateToAwsImdsV1Default) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/updateToAwsImdsV1][%d] updateToAwsImdsV1 default  %+v", o._statusCode, o.Payload)
}
