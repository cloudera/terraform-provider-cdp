...
func NewBackupDatalakeStatusParams() *BackupDatalakeStatusParams {
	return NewBackupDatalakeStatusParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BackupDatalakeStatusParams].
