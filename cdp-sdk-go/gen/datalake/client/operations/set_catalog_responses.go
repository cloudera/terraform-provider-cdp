...
func (o *SetCatalogOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/setCatalog][%d] setCatalogOK %s", 200, payload)
}
...
func (o *SetCatalogDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/setCatalog][%d] setCatalog default %s", o._statusCode, payload)
}
