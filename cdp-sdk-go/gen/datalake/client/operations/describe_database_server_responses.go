...
func (o *DescribeDatabaseServerOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/describeDatabaseServer][%d] describeDatabaseServerOK  %+v", 200, o.Payload)
}
...
func (o *DescribeDatabaseServerDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/describeDatabaseServer][%d] describeDatabaseServer default  %+v", o._statusCode, o.Payload)
}
