...
func (o *RecoverDatalakeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RecoverDatalakeOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/recoverDatalake][%d] recoverDatalakeOK %s", 200, payload)
}
...
func (o *RecoverDatalakeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.RecoverDatalakeResponse)
...
func (o *RecoverDatalakeDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/recoverDatalake][%d] recoverDatalake default %s", o._statusCode, payload)
}
