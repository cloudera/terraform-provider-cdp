...
func (o *CollectDatalakeDiagnosticsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/collectDatalakeDiagnostics][%d] collectDatalakeDiagnosticsOK  %+v", 200, o.Payload)
}
...
func (o *CollectDatalakeDiagnosticsDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/collectDatalakeDiagnostics][%d] collectDatalakeDiagnostics default  %+v", o._statusCode, o.Payload)
}
