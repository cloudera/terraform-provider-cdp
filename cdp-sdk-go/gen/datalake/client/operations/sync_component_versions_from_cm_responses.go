...
func (o *SyncComponentVersionsFromCmOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/syncComponentVersionsFromCm][%d] syncComponentVersionsFromCmOK  %+v", 200, o.Payload)
}
...
func (o *SyncComponentVersionsFromCmDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/datalake/syncComponentVersionsFromCm][%d] syncComponentVersionsFromCm default  %+v", o._statusCode, o.Payload)
}
