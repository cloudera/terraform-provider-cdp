...
func (o *ReplaceRecipesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ReplaceRecipesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/datalake/replaceRecipes][%d] replaceRecipesOK %s", 200, payload)
}
...
func (o *ReplaceRecipesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/datalake/replaceRecipes][%d] replaceRecipes default %s", o._statusCode, payload)
}
