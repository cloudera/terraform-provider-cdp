...
func (m *PrepareDatalakeUpgradeResponse) contextValidateCurrent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PrepareDatalakeUpgradeResponse) contextValidateUpgradeCandidates(ctx context.Context, formats strfmt.Registry) error {
