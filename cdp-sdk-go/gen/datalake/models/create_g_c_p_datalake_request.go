...
type CreateGCPDatalakeRequest struct {
	...
	// Whether to enable ranger RAZ for the datalake.
...
func (m *CreateGCPDatalakeRequest) validateDatabaseAvailabilityType(formats strfmt.Registry) error {
...
func (m *CreateGCPDatalakeRequest) contextValidateDatabaseAvailabilityType(ctx context.Context, formats strfmt.Registry) error {
