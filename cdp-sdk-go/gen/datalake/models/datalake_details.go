...
type DatalakeDetails struct {
	...
	// The load balancers associated with the datalake.
...
func (m *DatalakeDetails) validateLoadBalancers(formats strfmt.Registry) error {
...
func (m *DatalakeDetails) contextValidateLoadBalancers(ctx context.Context, formats strfmt.Registry) error {
