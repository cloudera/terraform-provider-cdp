...
type AdminOperationsBackupRestoreState struct {
	...
	// Run the temporary storage size validation in the database backup precheck.
	PrecheckBackupTemporaryStorage *BackupRestoreOperationStatus `json:"precheckBackupTemporaryStorage,omitempty"`
...
func (m *AdminOperationsBackupRestoreState) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePrecheckBackupTemporaryStorage(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AdminOperationsBackupRestoreState) validatePrecheckBackupTemporaryStorage(formats strfmt.Registry) error {
	if swag.IsZero(m.PrecheckBackupTemporaryStorage) { // not required
		return nil
	}

	if m.PrecheckBackupTemporaryStorage != nil {
		if err := m.PrecheckBackupTemporaryStorage.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("precheckBackupTemporaryStorage")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("precheckBackupTemporaryStorage")
			}
			return err
		}
	}
...
func (m *AdminOperationsBackupRestoreState) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidatePrecheckBackupTemporaryStorage(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *AdminOperationsBackupRestoreState) contextValidatePrecheckBackupTemporaryStorage(ctx context.Context, formats strfmt.Registry) error {

	if m.PrecheckBackupTemporaryStorage != nil {
		if err := m.PrecheckBackupTemporaryStorage.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("precheckBackupTemporaryStorage")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("precheckBackupTemporaryStorage")
