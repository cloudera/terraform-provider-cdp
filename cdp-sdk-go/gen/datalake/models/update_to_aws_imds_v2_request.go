...
// UpdateToAwsImdsV2Request Request object for updating Data Lake to use AWS IMDSv2.
//
...
func (m *UpdateToAwsImdsV2Request) validateCrn(formats strfmt.Registry) error {
...
func (m *UpdateToAwsImdsV2Request) UnmarshalBinary(b []byte) error {
	var res UpdateToAwsImdsV2Request
