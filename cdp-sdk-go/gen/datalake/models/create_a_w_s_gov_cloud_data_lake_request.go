...
// Validate validates this create a w s gov cloud data lake request
...
func (m *CreateAWSGovCloudDataLakeRequest) validateDatabaseAvailabilityType(formats strfmt.Registry) error {
...
func (m *CreateAWSGovCloudDataLakeRequest) validateSpotMaxPrice(formats strfmt.Registry) error {
...
func (m *CreateAWSGovCloudDataLakeRequest) validateSpotPercentage(formats strfmt.Registry) error {
...
// ContextValidate validate this create a w s gov cloud data lake request based on the context it is used
...
func (m *CreateAWSGovCloudDataLakeRequest) contextValidateDatabaseAvailabilityType(ctx context.Context, formats strfmt.Registry) error {
