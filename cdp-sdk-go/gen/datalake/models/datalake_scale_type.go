...
const (
	...
	// DatalakeScaleTypeMICRODUTY captures enum value "MICRO_DUTY"
	DatalakeScaleTypeMICRODUTY DatalakeScaleType = "MICRO_DUTY"
	...
	// DatalakeScaleTypeCUSTOM captures enum value "CUSTOM"
	DatalakeScaleTypeCUSTOM DatalakeScaleType = "CUSTOM"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["MICRO_DUTY","LIGHT_DUTY","MEDIUM_DUTY_HA","CUSTOM"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
