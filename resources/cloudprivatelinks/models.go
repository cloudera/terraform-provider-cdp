...
type cloudPrivateLinkResourceModel struct {
	...
	EndpointStatuses     types.List   `tfsdk:"endpoint_statuses"`
}

type awsAccountDetails struct {
	CloudAccountID          types.String `tfsdk:"cloud_account_id"`
	CrossAccountRoleDetails types.Object `tfsdk:"cross_account_role_details"`
...
type azureAccountDetails struct {
	AzureClientSecretCredential types.Object `tfsdk:"azure_client_secret_credential"`
	CredentialCRN               types.String `tfsdk:"credential_crn"`
...
func endpointStatusAttrTypes() map[string]attr.Type {
	return map[string]attr.Type{
		"service_component":  types.StringType,
