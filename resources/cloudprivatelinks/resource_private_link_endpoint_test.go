...
func TestCreatePrivateLinkEndpoint_AWS_Success(t *testing.T) {
	...
	mockOps.On("CreatePrivateLinkEndpointContext", mock.Anything, mock.AnythingOfType("*operations.CreatePrivateLinkEndpointParams")).
	...
	result, err := mockOps.CreatePrivateLinkEndpointContext(context.Background(), params)
...
func TestDeletePrivateLinkEndpoint_AWS_Success(t *testing.T) {
	...
	mockOps.On("DeletePrivateLinkEndpointContext", mock.Anything, mock.AnythingOfType("*operations.DeletePrivateLinkEndpointParams")).
	...
	result, err := mockOps.DeletePrivateLinkEndpointContext(context.Background(), params)
...
func TestListPrivateLinkEndpointStatuses_AllSuccess(t *testing.T) {
	...
	mockOps.On("ListPrivateLinkEndpointStatusesContext", mock.Anything, mock.AnythingOfType("*operations.ListPrivateLinkEndpointStatusesParams")).
	...
	result, err := mockOps.ListPrivateLinkEndpointStatusesContext(context.Background(), params)
...
func TestListPrivateLinkEndpointStatuses_PollProgression(t *testing.T) {
	...
	firstPoll, err := mockOps.ListPrivateLinkEndpointStatusesContext(context.Background(), params)
	assert.NoError(t, err)
	...
	secondPoll, err := mockOps.ListPrivateLinkEndpointStatusesContext(context.Background(), params)
	assert.NoError(t, err)
...
func TestGetPrivateLinkStatus_AWS_Enabled(t *testing.T) {
	...
	mockOps.On("GetPrivateLinkStatusContext", mock.Anything, mock.AnythingOfType("*operations.GetPrivateLinkStatusParams")).
	...
	result, err := mockOps.GetPrivateLinkStatusContext(context.Background(), params)
