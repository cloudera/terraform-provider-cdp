...
func TestAwsDatalakeSchemaMatchesDatalakeConfigSchema(t *testing.T) {
...
func TestAzureDatalakeSchemaMatchesDatalakeConfigSchema(t *testing.T) {
	assertSchemaPathsMatch(
		t,
		"Azure",
...
func TestGcpDatalakeSchemaMatchesDatalakeConfigSchema(t *testing.T) {
	assertSchemaPathsMatch(
		t,
		"GCP",
